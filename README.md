...
M.Sc. in Applied Computer Science @ **Georg-August-Universität Göttingen** specializing in **Machine Learning**, **Computational Neuroscience**, and **Computer Vision**. Currently conducting master's thesis research at **Volkswagen AG**, building LLM-powered semantic agents for enterprise data systems.

🔬 Research interests: Graph Neural Networks, NLP, Computer Vision, MLOps  
🎯 Building scalable AI solutions that bridge research and production  
📍 Göttingen, Germany | 🌍 Cairo, Egypt  
🎓 Graduating April 2026 | 💼 Open to full-time opportunities
...
🎓 **Niedersachsenstipendium** Recipient (2023)  
🥉 **3rd Place** - Al Empower Egypt Hackathon, Dell Technologies  
🥈 **2nd Rank** - Computer Networking Major, German University in Cairo  
🏅 **4th Place** - International Conference on Smart Cities Competition  

---

## 📝 Publications

- **Anomaly-Based Intrusion Detection System using Multi-Stage Features CNN1D** (2023)
- **Light MLP for Cloud Security** (2022)

---

## 💼 Professional Experience

**🚗 Volkswagen AG** - Master Thesis Student (June 2025 - Present)  
*Developing LLM-powered semantic agents for E/E architecture data access*

**🚗 Volkswagen AG** - Data Analysis Intern (Dec 2024 - June 2025)  
*Applied graph theory and ML for complex systems analysis*

**🎓 University of Göttingen** - MATLAB Tutor (Apr 2024 - July 2024)  
*Teaching and mentoring students in computational methods*
...
![English](https://img.shields.io/badge/English-C2-success?style=flat-square)
![German](https://img.shields.io/badge/German-B1-yellow?style=flat-square)
...
⭐️ *"Building intelligent systems that bridge research and production"*

![Visitors](https://visitor-badge.laobi.icu/badge?page_id=tamer017.tamer017)
