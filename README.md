...
|---|---|---|
| [**Anomaly-Based IDS CNN1D**](https://github.com/tamer017/Anomaly-baised-Intrusion-detection-system-CNN1D) | Multi-scale 1D-CNN for network intrusion detection on NSL-KDD | **>98% accuracy** |
| [**gml_project**](https://github.com/tamer017/gml_project) | DeepGCN for 3D point cloud classification on ModelNet40 | **GAT: 83% / 90% AUC** |
...
| Project | Description | Stack |
|---|---|---|
| [**AES-128 in Assembly**](https://github.com/tamer017/Advanced-Encyption-Standard-AES) | Bare-metal FIPS-197 AES-128 — GF(2⁸) arithmetic, 10 rounds, no libraries | Intel 8086 Assembly |
...
| Project | Description | Result |
|---|---|---|
| [**Cairo Temperature Forecast**](https://github.com/tamer017/Cairo-Temperature-forecasting) | XGBoost + Fourier seasonality + lag features | **RMSE: 2.3°C** |
| [**House Pricing**](https://github.com/tamer017/houses-pricing) | Stacked ensemble (Ridge+Lasso+GBM+XGBoost) on Ames Housing | **CV RMSE: 0.103** |
...
| Project | Description | Stack |
|---|---|---|
| [**For Her**](https://github.com/tamer017/for-her-) | Full-stack e-commerce: Redux · JWT · MongoDB aggregation pipelines | React · Node.js · MongoDB |
